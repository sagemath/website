...
def index(root, strip):
    ...
    for dir, dirs, files in os.walk(root):
        ...
        shortdir = dir[-keep:]
        title.appendChild(listxml.createTextNode('Sage Download - %s' % shortdir))
...
if __name__ == '__main__':
    ...
    os.chdir('/www-data/sagemath-org')
...
#    for d in map(os.path.abspath, ['./www/bin/', './www/bin/apple_osx/', './www/bin/microsoft_windows/', './www/bin/linux/', './www/bin/solaris/', './www/src/', './www/src-old/', './www/devel/', './www/spkg/upstream/']):
    for d in map(os.path.abspath, ['./www/bin/', './www/bin/apple_osx/', './www/bin/microsoft_windows/', './www/bin/linux/', './www/bin/solaris/', './www/src/', './www/src-old/', './www/spkg/upstream/']):
        os.chdir(d)
